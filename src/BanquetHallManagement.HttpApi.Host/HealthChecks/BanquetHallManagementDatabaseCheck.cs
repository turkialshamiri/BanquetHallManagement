...
public class BanquetHallManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public BanquetHallManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
