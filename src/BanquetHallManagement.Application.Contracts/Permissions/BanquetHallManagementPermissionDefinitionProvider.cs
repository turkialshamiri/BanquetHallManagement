...
public class BanquetHallManagementPermissionDefinitionProvider : PermissionDefinitionProvider
{
    ...
    {
        var myGroup = context.AddGroup(BanquetHallManagementPermissions.GroupName);

        //Define your own permissions here. Example:
        //myGroup.AddPermission(BanquetHallManagementPermissions.MyPermission1, L("Permission:MyPermission1"));
    }
