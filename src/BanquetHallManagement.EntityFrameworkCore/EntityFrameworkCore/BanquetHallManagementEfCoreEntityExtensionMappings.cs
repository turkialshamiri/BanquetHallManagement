...
public static class BanquetHallManagementEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE BanquetHallManagementModuleExtensionConfigurator CLASS (in the Domain.Shared project)
