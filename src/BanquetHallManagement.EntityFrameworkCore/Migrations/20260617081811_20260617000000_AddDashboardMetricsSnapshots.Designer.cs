...
namespace BanquetHallManagement.Migrations
{
    ...
    [Migration("20260617081811_20260617000000_AddDashboardMetricsSnapshots")]
    partial class _20260617000000_AddDashboardMetricsSnapshots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BanquetHallManagement.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("BanquetHallManagement.Dashboard.DashboardMetricsSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<long>("CancelledReservations")
                        .HasColumnType("bigint");

                    b.Property<long>("CompletedReservations")
                        .HasColumnType("bigint");

                    b.Property<long>("ConfirmedReservations")
                        .HasColumnType("bigint");

                    b.Property<long>("PendingReservations")
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("TotalDeferredRevenue")
                        .HasColumnType("decimal(18,2)");

                    b.Property<long>("TotalHalls")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DashboardMetricsSnapshots", (string)null);
                });

            modelBuilder.Entity("BanquetHallManagement.Entities.BanquetHallManagement.Entities.Hall", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BanquetHallManagement.Finance.HallAccessCards.HallAccessCard", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("HallAccessCards", null, t =>
                        {
                            t.HasComment("جدول بطاقات دخول القاعات.");
                        });
                });

            modelBuilder.Entity("BanquetHallManagement.Finance.Invoices.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BanquetHallManagement.Finance.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BanquetHallManagement.ReservationServices.ReservationService", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BanquetHallManagement.Finance.HallAccessCards.HallAccessCard", b =>
                {
                    b.HasOne("BanquetHallManagement.Reservations.Reservation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BanquetHallManagement.Finance.Invoices.Invoice", b =>
                {
                    b.HasOne("BanquetHallManagement.Finance.Payments.Payment", null)
                        .WithMany()
