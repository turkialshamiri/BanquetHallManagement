...
public class ReservationCompletedDomainEventHandler :
    ReservationDomainEventHandlerBase<ReservationCompletedDomainEvent>
{
    public ReservationCompletedDomainEventHandler(
        IRepository<Hall, Guid> hallRepository,
        IRepository<Customer, Guid> customerRepository,
        ReservationDistributedEventPublisher publisher,
        ILogger<ReservationCompletedDomainEventHandler> logger)
    ...
    protected override Task PublishDistributedEventsAsync(
        ...
        Customer customer)
    {
        return Publisher.PublishCompletedAsync(snapshot, hall, customer);
    }
}
