...
public class ReservationConfirmedDomainEventHandler :
    ReservationDomainEventHandlerBase<ReservationConfirmedDomainEvent>
{
    ...
    protected override Task PublishDistributedEventsAsync(
        ...
        Customer customer)
    {
        return Publisher.PublishConfirmedAsync(snapshot, hall, customer);
    }
}
