...
public class ReservationCompletedNotificationHandler :
    IDistributedEventHandler<ReservationNotificationEto>,
    ITransientDependency
{
    private readonly ILogger<ReservationCompletedNotificationHandler> _logger;

    public ReservationCompletedNotificationHandler(
        ILogger<ReservationCompletedNotificationHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        if (eventData.NotificationType != ReservationNotificationTypes.Completed)
        {
