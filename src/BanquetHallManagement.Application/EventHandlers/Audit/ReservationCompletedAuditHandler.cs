...
public class ReservationCompletedAuditHandler :
    IDistributedEventHandler<ReservationAuditEto>,
    ITransientDependency
{
    private readonly ILogger<ReservationCompletedAuditHandler> _logger;

    public ReservationCompletedAuditHandler(ILogger<ReservationCompletedAuditHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        if (eventData.Action != ReservationAuditActions.Completed)
        {
