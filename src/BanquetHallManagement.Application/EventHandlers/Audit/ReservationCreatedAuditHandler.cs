...
public class ReservationCreatedAuditHandler :
    IDistributedEventHandler<ReservationAuditEto>,
    ITransientDependency
{
    private readonly ILogger<ReservationCreatedAuditHandler> _logger;

    public ReservationCreatedAuditHandler(ILogger<ReservationCreatedAuditHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        if (eventData.Action != ReservationAuditActions.Created)
        {
