...
* Check the `ConnectionStrings` in `appsettings.json` files under the `BanquetHallManagement.HttpApi.Host` and `BanquetHallManagement.DbMigrator` projects and change it if you need.
...
> `ed0653a5-a03d-435c-a129-cb0e2fb15ffa` is the password of the certificate, you can change it to any password you want.
