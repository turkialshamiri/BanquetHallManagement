...
{
    [Fact]
    public void CalculateDeferredAmount_Should_Exclude_NonRefundable_Deposit_Portion()
    {
    ...
    [Fact]
    public void CalculateDeferredAmount_Should_Sum_Installments_Final_And_Deferred_Deposit_Portion()
    {
    ...
    [Fact]
    public void CalculateDeferredAmount_Should_Split_Deposit_Payment_Above_Minimum()
    {
        var totalPrice = 100_000m;
        var payments = new[]
        {
            CreatePayment(PaymentType.Deposit, 50_000m),
        };

        var deferred = DeferredRevenueCalculator.CalculateDeferredAmount(totalPrice, payments);

        deferred.ShouldBe(20_000m);
    }
